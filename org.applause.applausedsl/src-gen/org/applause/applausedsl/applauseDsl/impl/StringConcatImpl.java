 ...
 * <ul>
 *   <li>{@link org.applause.applausedsl.applauseDsl.impl.StringConcatImpl#getValues <em>Values</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StringConcatImpl extends StringFunctionImpl implements StringConcat
{
  ...
  {
    return ApplauseDslPackage.Literals.STRING_CONCAT;
  }
  ...
  public EList<ScalarExpression> getValues()
  {
    if (values == null)
    {
      values = new EObjectContainmentEList<ScalarExpression>(ScalarExpression.class, this, ApplauseDslPackage.STRING_CONCAT__VALUES);
    }
    return values;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ApplauseDslPackage.STRING_CONCAT__VALUES:
