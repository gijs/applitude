...
public class BlogDetails extends DetailsActivity<BlogItem> {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setHeaderImageURL("http://blogs.itemis.de/wp-content/themes/itemis-WP-Theme/photos/"
				+ urlconform(item.getAuthor()) + ".jpg");
	...
	private class Cell1 extends RowAdapter.Default<Void> {
		...
		public void handleClick() {
			...
			Intent intent = new Intent(BlogDetails.this, SprecherDetails.class);
			Serializable contentProvider = ProviderFactory
					.getSprecherByNameProvider(item.getAuthor());
