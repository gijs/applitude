	...
	for(BlogItem i : items1)
		...
		private class Cell1 extends RowAdapter.Subtitle<BlogItem> {
			...
			public void populateRowView() {
				...
				setImageURL("http://blogs.itemis.de/wp-content/themes/itemis-WP-Theme/photos/" + urlconform(i.getAuthor()) + ".jpg");
			}
			...
			Serializable contentProvider = new SimpleItemContentProvider<Object>(i);
