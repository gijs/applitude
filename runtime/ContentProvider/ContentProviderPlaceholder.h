...
// ContentProviderPlaceholder will return the loadingCurtain (like
// a curtain in front of the loading/not yet present content).
// loadingCurtain should contain items of the same type as
...
@property (nonatomic, retain) id loadingCurtain;
