		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getApplicationAccess().getTabsAssignment_4(), "rule__Application__TabsAssignment_4");
					put(grammarAccess.getTabAccess().getTitleAssignment_0_2_2(), "rule__Tab__TitleAssignment_0_2_2");
					put(grammarAccess.getTabAccess().getIconAssignment_1_2(), "rule__Tab__IconAssignment_1_2");
					put(grammarAccess.getTabAccess().getViewAssignment_2_0_2(), "rule__Tab__ViewAssignment_2_0_2");
					...
					put(grammarAccess.getTableViewAccess().getTitleAssignment_6(), "rule__TableView__TitleAssignment_6");
					put(grammarAccess.getTableViewAccess().getSectionsAssignment_7(), "rule__TableView__SectionsAssignment_7");
					...
					put(grammarAccess.getDetailsViewAccess().getTitleAssignment_6(), "rule__DetailsView__TitleAssignment_6");
					put(grammarAccess.getDetailsViewAccess().getHeaderAssignment_7(), "rule__DetailsView__HeaderAssignment_7");
					put(grammarAccess.getDetailsViewAccess().getSectionsAssignment_8(), "rule__DetailsView__SectionsAssignment_8");
					...
					put(grammarAccess.getViewHeaderAccess().getTitleAssignment_3_2(), "rule__ViewHeader__TitleAssignment_3_2");
					put(grammarAccess.getViewHeaderAccess().getSubtitleAssignment_4_2(), "rule__ViewHeader__SubtitleAssignment_4_2");
					put(grammarAccess.getViewHeaderAccess().getDetailsAssignment_5_2(), "rule__ViewHeader__DetailsAssignment_5_2");
					put(grammarAccess.getViewHeaderAccess().getImageAssignment_6_2(), "rule__ViewHeader__ImageAssignment_6_2");
					put(grammarAccess.getViewSectionAccess().getTitleAssignment_2_2(), "rule__ViewSection__TitleAssignment_2_2");
					...
					put(grammarAccess.getSectionCellAccess().getTextAssignment_4_2(), "rule__SectionCell__TextAssignment_4_2");
					put(grammarAccess.getSectionCellAccess().getDetailsAssignment_5_2(), "rule__SectionCell__DetailsAssignment_5_2");
					put(grammarAccess.getSectionCellAccess().getImageAssignment_6_2(), "rule__SectionCell__ImageAssignment_6_2");
					put(grammarAccess.getSectionCellAccess().getActionAssignment_7_2(), "rule__SectionCell__ActionAssignment_7_2");
