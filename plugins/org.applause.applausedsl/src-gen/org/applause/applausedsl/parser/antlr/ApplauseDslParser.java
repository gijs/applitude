...
public class ApplauseDslParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	protected IParseResult parse(String ruleName, CharStream in) {
		...
		org.applause.applausedsl.parser.antlr.internal.InternalApplauseDslParser parser = createParser(tokenStream);
	...
	protected org.applause.applausedsl.parser.antlr.internal.InternalApplauseDslParser createParser(XtextTokenStream stream) {
		return new org.applause.applausedsl.parser.antlr.internal.InternalApplauseDslParser(stream, getElementFactory(), getGrammarAccess());
	}
